package com.DesarrolloCreativo.DesarrolloCreativo.Seguridad;

import com.DesarrolloCreativo.DesarrolloCreativo.Handler.CustomSuccessHandler;
...
public class ConfigSeguridad extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/Movements/**").hasAnyRole("ADMIN","USER")
